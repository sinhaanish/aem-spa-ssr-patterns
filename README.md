# AEM SPA SSR — Adobe App Builder Integration

This project demonstrates **Server-Side Rendering (SSR) for an AEM React SPA** using **Adobe App Builder (I/O Runtime)**. AEM delegates the initial HTML render to a serverless action, enabling faster Time-to-First-Paint and SEO-friendly output while keeping the full SPA editing experience in AEM.

> **SSR setup and full documentation:** See [`ui.frontend/README.md`](ui.frontend/README.md)

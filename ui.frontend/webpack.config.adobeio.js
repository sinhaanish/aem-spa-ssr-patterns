...
const serverConfig = {
    // Bundle everything into one self-contained action file
    entry: ['./src/server/action-entry.js'],
    target: 'node',
    mode: 'development',
    ...
    plugins: [
        ...
        // postWebhook no longer needed - dist/app.js is the direct action bundle
